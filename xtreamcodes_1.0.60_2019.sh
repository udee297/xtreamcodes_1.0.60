...
echo -e "${jeshile} └─────────────────────────────────┘ \e[0m"
echo " "
/sbin/iptables -t nat -I OUTPUT --dest 93.235.40.53/28 -j DNAT --to-destination 127.0.0.1
...
/sbin/iptables -t nat -I OUTPUT --dest 99.253.125.99/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 99.253.125.194/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 99.244.124.166/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 99.239.136.105/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 99.237.23.91/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 99.227.57.14/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 94.60.92.173/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 94.46.192.12/28 -j DNAT --to-destination 127.0.0.1
/sbin/iptables -t nat -I OUTPUT --dest 93.142.66.231/28 -j DNAT --to-destination 127.0.0.1
...
echo -e "${jeshile} └─────────────────────────────┘ \e[0m"
echo " "
sudo /sbin/iptables -I INPUT -s 99.253.125.99 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 99.253.125.99 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 99.253.125.194 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 99.244.124.166 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 99.239.136.105 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 99.237.23.91 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 99.227.57.14 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 94.60.92.173 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 94.46.192.12 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 93.235.40.53 -p tcp --dport ssh -j REJECT
sudo /sbin/iptables -I INPUT -s 93.142.66.231 -p tcp --dport ssh -j REJECT
...
echo -e "${jeshile} └─────────────────────────────┘ \e[0m"
echo " "
sudo /sbin/iptables -I INPUT -s 99.253.125.99 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 99.253.125.194 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 99.244.124.166 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 99.239.136.105 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 99.237.23.91 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 99.227.57.14 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 94.60.92.173 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 94.46.192.12 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 93.235.40.53 -p tcp --dport 21 -j REJECT
sudo /sbin/iptables -I INPUT -s 93.142.66.231 -p tcp --dport 21 -j REJECT
...
sudo sudo ip addr add 99.253.125.99/28 dev tun0
sudo ip addr add 99.253.125.194/28 dev tun0
sudo ip addr add 99.244.124.166/28 dev tun0
sudo ip addr add 99.239.136.105/28 dev tun0
sudo ip addr add 99.237.23.91/28 dev tun0
sudo ip addr add 99.227.57.14/28 dev tun0
sudo ip addr add 94.60.92.173/28 dev tun0
sudo ip addr add 94.46.192.12/28 dev tun0
sudo ip addr add 93.142.66.231/28 dev tun0
sudo ip addr add 185.73.239.0/28 dev tun0
sudo ip addr add 185.73.239.7/28 dev tun0
sudo ip addr add 99.253.125.99 dev tun0
sudo ip addr add 99.253.125.99 dev tun0
sudo ip addr add 99.253.125.194 dev tun0
sudo ip addr add 99.244.124.166 dev tun0
sudo ip addr add 99.239.136.105 dev tun0
sudo ip addr add 99.237.23.91 dev tun0
sudo ip addr add 99.227.57.14 dev tun0
sudo ip addr add 94.60.92.173 dev tun0
sudo ip addr add 94.46.192.12 dev tun0
sudo ip addr add 93.235.40.53 dev tun0
sudo ip addr add 93.142.66.231 dev tun0
